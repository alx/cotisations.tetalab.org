...
/* $Id: Smarty_Compiler.class.php 129 2004-09-21 22:59:32Z deelight $ */
...
class Smarty_Compiler extends Smarty {
    ...
    function Smarty_Compiler()
    {
        ...
        //$this->_func_call_regexp = '(?:[a-zA-Z_]\s*)\(?:(.*)\"\)';
        $this->_func_call_regexp = '_T\(\"(.*)\"\)';
    ...
    function _compile_tag($template_tag)
    {
        ...
        if(! preg_match('~^(?:(' . $this->_num_const_regexp . '|' . $this->_obj_call_regexp . '|' . $this->_var_regexp 
                ...
                // Galette customisation
                if (preg_match('~^(?:(' . $this->_func_call_regexp . '|\/?' . $this->_func_regexp . ')(' . $this->_mod_regexp . '*))
                        (?:\s+(.*))?$
                        ~xs',$template_tag,$match))
                {
                        $match[1] = 'trans';
            ...
            //    // added for Galette
            //    $match[1]='_T';
            //    $match[3]=substr(substr($template_tag,4),0,strlen($template_tag)-6);
            //}
        }
